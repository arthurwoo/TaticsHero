...
public class LayoutAnchor : MonoBehaviour {
	...
	public void SnapToAnchorPisition(TextAnchor myAnchor, TextAnchor parentAnchor, Vector2 offset) {
		myRT.anchoredPosition = AnchorPosition (myAnchor, parentAnchor, offset);
	}

	public Tweener MoveToAnchorPisition(TextAnchor myAnchor, TextAnchor parentAnchor, Vector2 offset) {
