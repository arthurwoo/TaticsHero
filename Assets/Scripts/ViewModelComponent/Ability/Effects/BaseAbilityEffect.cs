...
public abstract class BaseAbilityEffect : MonoBehaviour {
	...
	public const string GetDefenseNotification = "BaseAbilityEffect.GetDefenceNotification";
	...
	public const string HitNotification = "BaseAibilityEffect.HitNotification";
